...
module.exports = withMT({
    ...
    safelist: [
        ...
        {
            pattern: /(^text-(neutral|red|blue|green|yellow|orange|cyan|slate|gray|zinc|stone|amber|lime|emerald|teal|sky|indigo|violet|purple|fuchsia|pink|rose)-(50|100|200|300|400|500|600|700|800|900|950)$)/
        },
        {
            pattern: /(^border-(neutral|red|blue|green|yellow|orange|cyan|slate|gray|zinc|stone|amber|lime|emerald|teal|sky|indigo|violet|purple|fuchsia|pink|rose)-(50|100|200|300|400|500|600|700|800|900|950)$)/
        }
    ],
}
)
